...
// Generated By AI from my old SCSS code
const shadows = {
...
const config: Config = {
	...
	theme: {
		extend: {
			...
			boxShadow: shadows,
			dropShadow: {
				secondary: "0 1px 4px rgba(57, 69, 90, 0.3)",
				custom: `0 0.275em 0.75em ${colors.shadow.primary}0f`,
				"custom-large": `0 0.3em 1.5em ${colors.shadow.primary}1a`,
				"custom-offset": "-2.75em 1.625em 1.25em rgba(6, 3, 18, 0.34)",
			},
			colors: {
				...colors,
