...
function AppFeatures() {
	return (
		<>
			<section aria-label="App Features" className="app-features">
				<div className="app-features-container">
					...
					<Image
						...
						width={348}
						height={684}
						className="app-features-container__phone-image"
					/>
					<div>
						<h1 className="app-features-container__heading">App Features</h1>
						<p className="app-features-container__p-text">
						...
						<div className="app-features-container__app-features-cards">
							<div className="app-features-container__app-features-cards__card-container">
								<Image
									src="/images/app-features/credit-card.svg"
									alt="App Features - Credit Card"
									width={28}
									height={28}
									className="app-features-container__app-features-cards__card-container__img"
								/>
								<div className="app-features-container__app-features-cards__card-container__card-item">
									<h5>Easy Payments</h5>
									<p>
